...
min_edge_cost = 1 # must be min value for heuristic cost to work
...
class BoxWorld(object):
    ...
    def set_start(self, idx):
        ...
        self.start.marker = 'S'
        self.agents = Agent(self.start._vc.x, self.start._vc.y, self.boxes)
    ...
    def plan_path(self, search, limit):
        ...
        #Plan the path for the agent according to the search method chosen

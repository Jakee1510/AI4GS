...
actions = {
    'get raw food': { 'Eat': -2, 'Toilet': +3},
    'get snack': { 'Eat': -2, 'Toilet': +3},
...
def action_utility(action, goal):
    ##ACTION_UTILITY IS GET GOAL CHANGE
    ##GOALS[1:] IS GOALS.ITEMS()
    ...
    if goal in actions[action]:
        ...
        print("Action::", action)
        print("Goal::", goal)
        print("what is this:::: ", -sum(actions[action].values()))
